...
Route::group(['namespace'=>'Frontend', 'middleware' => ['ipcheck','check_refer']], function() {
    ...
    Route::get('brand', [FrontendController::class, 'brandIndex'])->name('brand');
    Route::get('brand/{slug}', [FrontendController::class, 'brand'])->name('brand.products');
...
Route::post('/cart/store', [FrontendController::class, 'cartStore'])->name('cart.store');
    ...
    Route::get('cart/mini-dropdown', [ShoppingController::class, 'cartMiniDropdown'])->name('cart.mini');
    Route::get('cart/header-hover', [ShoppingController::class, 'headerCartHover'])->name('cart.header-hover');
