    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable <?php echo e($popupImageOnly ? 'pop-banner-dialog' : 'modal-lg'); ?>">
        <div class="modal-content ps-content <?php echo e($popupImageOnly ? 'ps-content-image-only' : ''); ?>">
            ...
            <div class="ps-image-only-wrap">
                ...
                <a href="<?php echo e($popup->link); ?>" target="_blank" rel="noopener noreferrer" class="d-block">
                    <img src="<?php echo e($popupImageUrl); ?>" alt="<?php echo e($popup->title ?? 'Promotional offer'); ?>" class="img-fluid w-100">
                </a>
                <?php else: ?>
                <img src="<?php echo e($popupImageUrl); ?>" alt="<?php echo e($popup->title ?? 'Promotional offer'); ?>" class="img-fluid w-100">
                <?php endif; ?>
            ...
            <div class="ps-layout">
                <div class="ps-text-section">
                    ...
                    <a href="<?php echo e($popup->link ?? '#'); ?>" class="ps-btn" <?php if(!empty($popup->link) && $popup->link !== '#'): ?> target="_blank" rel="noopener noreferrer" <?php endif; ?>>
                    ...
                    <div class="ps-footer">
                        ...
                        <span>POWERED BY <strong><?php echo e(optional($generalsetting ?? null)->name ?? config('app.name', 'Store')); ?></strong></span>
                    </div>
                </div>

                <div class="ps-image-section">
                    <img src="<?php echo e($popupImageUrl); ?>" alt="<?php echo e($popup->title ?? 'Offer'); ?>">
                </div>
            </div>
            <?php endif; ?>
        </div>
...
<?php endif; ?>
<?php /**PATH C:\dms office\pos ecommerce\resources\views/frontEnd/layouts/partials/marketing_popup.blade.php ENDPATH**/ ?>