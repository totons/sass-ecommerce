...
<head>
    ...
    <meta name="theme-color" content="<?php echo e($generalsetting->primary_color ?? '#3c7d17'); ?>">
    ...
    <?php if(!empty(optional($generalsetting)->facebook_verification)): ?>
    <meta name="facebook-domain-verification" content="<?php echo e($generalsetting->facebook_verification); ?>" />
    <?php endif; ?>
    <?php if(!empty(optional($generalsetting)->google_verification)): ?>
    ...
    <?php if(empty($pixel->code)) continue; ?>
    <!-- Facebook Pixel <?php echo e($loop->iteration); ?> -->
    <script>
        ...
        fbq('init', <?php echo json_encode($pixel->code, 15, 512) ?>);
        fbq('track', 'PageView');
    </script>
    <noscript><img height="1" width="1" style="display:none" alt=""
        src="https://www.facebook.com/tr?id=<?php echo e(urlencode($pixel->code)); ?>&ev=PageView&noscript=1" /></noscript>
    ...
    <?php if(empty($gtm->code)) continue; ?>
    <?php $gtmId = str_starts_with((string)$gtm->code, 'GTM-') ? $gtm->code : 'GTM-' . $gtm->code; ?>
    <!-- Google Tag Manager -->
    <script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
    new Date().getTime(),event:'gtm.js'});var f=d.getElementsByTagName(s)[0],
    j=d.createElement(s),dl=l!='dataLayer'?'&l='+l:'';j.async=true;j.src=
    'https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);
    })(window,document,'script','dataLayer',<?php echo json_encode($gtmId, 15, 512) ?>);</script>
    ...
    <?php if(empty($tp->code)) continue; ?>
    <!-- TikTok Pixel <?php echo e($loop->iteration); ?> -->
    <script>
        ...
        ttq.load(<?php echo json_encode($tp->code, 15, 512) ?>);
        ttq.page();
    }(window, document, 'ttq');
    </script>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    ...
    <script>
        window.dataLayer.push({
            event: 'page_context',
            pageType: <?php echo json_encode($pageType ?? \Illuminate\Support\Facades\Route::currentRouteName() ?? 'general', 15, 512) ?>,
            pagePath: <?php echo json_encode(parse_url(url()->current(), PHP_URL_PATH) ?: '/', 512) ?>,
            pageTitle: <?php echo json_encode(strip_tags($__env->yieldContent('title') ?: '') . ' - ' . ($generalsetting->name ?? ''), 15, 512) ?>,
            siteName: <?php echo json_encode($generalsetting->name ?? '', 15, 512) ?>,
            currency: 'BDT',
            language: 'bn'
        });
    ...
    <link rel="stylesheet" href="<?php echo e(asset('public/frontEnd/styles.css')); ?>?v=<?php echo e(@filemtime(public_path('frontEnd/styles.css'))); ?>">
    ...
    <style>
        :root {
            --brand-primary: <?php echo e($generalsetting->primary_color ?? '#3c7d17'); ?>;
            --brand-secondary: <?php echo e($generalsetting->secodery_color ?? '#326814'); ?>;
            --footer-bg: <?php echo e($generalsetting->footer_color ?? '#1a1a1a'); ?>;
            --footer-copyright-text: <?php echo e($generalsetting->copyright_color ?? 'rgba(255,255,255,0.88)'); ?>;
        }
    </style>
...
<body>
    ...
    <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=<?php echo e(urlencode($gtmId)); ?>"
                ...
                <div class="mobile-nav-category-list">
                    <?php $__currentLoopData = $menucategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $scategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="mobile-nav-row">
                            <a href="<?php echo e(route('category', $scategory->slug)); ?>" class="mobile-nav-main-link">
                                <?php echo e($scategory->name ?? ucwords(str_replace('-', ' ', $scategory->slug))); ?>

                            </a>

                            <?php if(!empty($scategory->subcategories) && $scategory->subcategories->count() > 0): ?>
                                <button type="button" class="mobile-nav-toggle" data-target="#<?php echo e($mainSubsId); ?>" aria-label="Toggle subcategories">+</button>
                            <?php else: ?>
                        ...
                        <?php if(!empty($scategory->subcategories) && $scategory->subcategories->count() > 0): ?>
                            <ul class="mobile-nav-subcat-list" id="<?php echo e($mainSubsId); ?>">
                                <?php $__currentLoopData = $scategory->subcategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subcategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <li>
                                        <div class="mobile-nav-row mobile-nav-subcat-row">
                                            <a href="<?php echo e(route('subcategory', $subcategory->slug)); ?>" class="mobile-nav-subcat-link">
                                                <?php echo e($subcategory->subcategoryName ?? $subcategory->name); ?>

                                            </a>

                                            <?php if(!empty($subcategory->childcategories) && $subcategory->childcategories->count() > 0): ?>
                                                <button type="button" class="mobile-nav-toggle" data-target="#<?php echo e($subChildId); ?>" aria-label="Toggle child categories">+</button>
                                            <?php else: ?>
                                                <span class="mobile-nav-toggle-placeholder" aria-hidden="true"> </span>
                                            <?php endif; ?>
                                        </div>
                                        ...
                                        <?php if(!empty($subcategory->childcategories) && $subcategory->childcategories->count() > 0): ?>
                                            <ul class="mobile-nav-childcat-list" id="<?php echo e($subChildId); ?>">
                                                <?php $__currentLoopData = $subcategory->childcategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $childcat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <li>
                                                        <a href="<?php echo e(route('products', $childcat->slug)); ?>" class="mobile-nav-childcat-link">
                                                            <?php echo e($childcat->childcategoryName ?? $childcat->name); ?>
...
<a href="<?php echo e(route('home')); ?>" class="logo"><img src="<?php echo e(asset($generalsetting->dark_logo)); ?>" alt=""></a>
                <a href="<?php echo e(route('brand')); ?>" class="brands-link">BRANDS</a>
            </div>
            <div class="search-section">
                <form action="<?php echo e(route('search')); ?>" method="GET" class="search-form">
                    <div class="search-bar">
                        <input type="text" placeholder="<?php echo e($generalsetting->search_placeholder ?? 'Grab Himalaya upto 50%'); ?>" name="keyword" class="search_keyword search_click" autocomplete="off" />
            ...
            <div class="action-buttons">
                <a href="<?php echo e(route('customer.order_track')); ?>" class="btn-wishlist" style="text-decoration:none;display:inline-flex;align-items:center;justify-content:center;">TRACK ORDER</a>
                <?php if(Auth::guard('customer')->check()): ?>
                <a href="<?php echo e(route('customer.account')); ?>" class="btn-login" style="text-decoration:none;display:inline-flex;align-items:center;justify-content:center;"><?php echo e(Str::limit(Auth::guard('customer')->user()->name, 12)); ?></a>
                <?php else: ?>
                <a href="<?php echo e(route('customer.login')); ?>" class="btn-login" style="text-decoration:none;display:inline-flex;align-items:center;justify-content:center;">LOGIN</a>
                <?php endif; ?>
                <?php
                ...
                <div class="header-cart-hover-wrap">
                    <a href="javascript:void(0)" class="btn-bag cart-open-btn" onclick="openSidebarCart()" style="text-decoration:none;display:inline-flex;align-items:center;gap:10px;color:#fff;">
                        ...
                        <span class="bag-count mobilecart-qty"><?php echo e(Cart::instance('shopping')->count()); ?></span>
                    </a>
                    <div class="header-cart-hover-dropdown" role="region" aria-label="কার্ট সারাংশ">
                        <div id="headerCartHoverContent">
                            <?php echo $__env->make('frontEnd.layouts.ajax.header_cart_hover', ['cartContent' => $headerCartContent, 'subtotal' => $headerCartSubtotal, 'generalsetting' => $generalsetting], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <nav class="main-nav">
        <div class="nav-container">
            ...
            ?>
            <?php if($menuCats->count() > 0): ?>
                <div class="nav-links">
                    <?php $__currentLoopData = $menuCats->take(6); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="nav-item-dropdown" tabindex="0">
                            <a href="<?php echo e(route('category', $cat->slug)); ?>" class="nav-link-main"><?php echo e($cat->name); ?></a>
                            <?php if($cat->subcategories && $cat->subcategories->count() > 0): ?>
                                <?php if($cat->subcategories->count() > 1): ?>
                                    
                                    <div class="mega-menu-panel" role="navigation" aria-label="<?php echo e($cat->name); ?>">
                                        <div class="mega-menu-inner" style="--subcount: <?php echo e($cat->subcategories->count()); ?>;">
                                            <div class="mega-menu-grid">
                                                <?php $__currentLoopData = $cat->subcategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sub): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <div class="mega-menu-col">
                                                        <a href="<?php echo e(route('subcategory', $sub->slug)); ?>" class="mega-menu-heading"><?php echo e(strtoupper($sub->subcategoryName)); ?></a>
                                                        <?php if($sub->childcategories && $sub->childcategories->count() > 0): ?>
                                                            <ul class="mega-menu-list">
                                                                <?php $__currentLoopData = $sub->childcategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $child): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    <li><a href="<?php echo e(route('products', $child->slug)); ?>"><?php echo e($child->childcategoryName); ?></a></li>
                                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                            </ul>
                                                        <?php endif; ?>
                                                    </div>
                                ...
                                <?php else: ?>
                                    ...
                                    <?php $singleSub = $cat->subcategories->first(); ?>
                                    <div class="mega-menu-panel mega-menu-panel--single" role="navigation" aria-label="<?php echo e($cat->name); ?>">
                                        <div class="mega-menu-single-inner">
                                            <?php if($singleSub->childcategories && $singleSub->childcategories->count() > 0): ?>
                                                <ul class="mega-menu-single-list">
                                                    <?php $__currentLoopData = $singleSub->childcategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $child): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <li><a href="<?php echo e(route('products', $child->slug)); ?>"><?php echo e($child->childcategoryName); ?></a></li>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </ul>
                                            <?php else: ?>
                                                <a href="<?php echo e(route('subcategory', $singleSub->slug)); ?>" class="mega-menu-single-link"><?php echo e($singleSub->subcategoryName); ?></a>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                <?php endif; ?>
                ...
                <?php if($menuCats->count() > 6): ?>
                    <div class="nav-pills">
                        <?php $__currentLoopData = $menuCats->skip(6); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="nav-item-dropdown nav-pill-dropdown" tabindex="0">
                                <a href="<?php echo e(route('category', $cat->slug)); ?>" class="pill <?php echo e($pillColors[$idx % count($pillColors)]); ?>"><?php echo e(strtoupper($cat->name)); ?></a>
                                <?php if($cat->subcategories && $cat->subcategories->count() > 0): ?>
                                    <?php if($cat->subcategories->count() > 1): ?>
                                        <div class="mega-menu-panel mega-menu-panel--pill" role="navigation" aria-label="<?php echo e($cat->name); ?>">
                                            <div class="mega-menu-inner" style="--subcount: <?php echo e($cat->subcategories->count()); ?>;">
                                                <div class="mega-menu-grid">
                                                    <?php $__currentLoopData = $cat->subcategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sub): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <div class="mega-menu-col">
                                    ...
                                    <?php else: ?>
                                        <?php $singleSub = $cat->subcategories->first(); ?>
                                        <div class="mega-menu-panel mega-menu-panel--single mega-menu-panel--pill" role="navigation" aria-label="<?php echo e($cat->name); ?>">
                                            <div class="mega-menu-single-inner">
                                                <?php if($singleSub->childcategories && $singleSub->childcategories->count() > 0): ?>
                                                    <ul class="mega-menu-single-list">
                                                        <?php $__currentLoopData = $singleSub->childcategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $child): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <?php else: ?>
                <div class="nav-links">
                    <a href="<?php echo e(route('shop')); ?>" class="nav-link-main">Shop</a>
                </div>
            <?php endif; ?>
        </div>
    </nav>
 ...
 <?php echo $__env->yieldContent('content'); ?>
        ...
        <div class="nf-container">
            <div class="nf-grid">
                <div class="nf-col nf-about">
                    <a href="<?php echo e(route('home')); ?>" class="nf-logo">
                        <img src="<?php echo e(asset($generalsetting->white_logo)); ?>" alt="<?php echo e($generalsetting->name); ?> logo">
                    </a>
                    <p class="nf-about-text">
                        <?php echo e(optional($generalsetting)->footer_about_text ?? 'আপনার ব্যবসার ডিজিটাল পার্টনার। আমরা বিশ্বাস করি গুণগত মান এবং গ্রাহক সন্তুষ্টিতে। প্রযুক্তির সাথে এগিয়ে চলুন আমাদের সাথে।'); ?>

                    </p>
                    <?php if(!empty($contact->hotline)): ?>
                        <a href="tel:<?php echo e($contact->hotline); ?>" class="nf-hotline"><?php echo e($contact->hotline); ?></a>
                    <?php endif; ?>

                    <div class="nf-app-badges">
                        <?php if(!empty(optional($generalsetting)->google_play_link)): ?>
                            <a href="<?php echo e(optional($generalsetting)->google_play_link); ?>" class="nf-badge" target="_blank" rel="noopener">
                                <img src="/public/uploads/play.svg" alt="Get it on Google Play">
                            </a>
                        <?php endif; ?>
                        <?php if(!empty(optional($generalsetting)->app_store_link)): ?>
                            <a href="<?php echo e(optional($generalsetting)->app_store_link); ?>" class="nf-badge" target="_blank" rel="noopener">
                ...
                <div class="nf-col">
                    ...
                    <ul class="nf-list">
                        <li><a href="<?php echo e(route('sellers')); ?>">All Sellers</a></li>
                ...
                <div class="nf-col">
                    ...
                    <form action="<?php echo e(route('frontend.newsletter.subscribe')); ?>" method="POST" class="nf-newsletter-form">
                        <?php echo csrf_field(); ?>
                    ...
                    <?php if($socialicons->count() > 0): ?>
                        <ul class="nf-social">
                            <?php $__currentLoopData = $socialicons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li>
                                    <a href="<?php echo e($value->link); ?>" class="nf-social-link" target="_blank" rel="noopener" aria-label="social">
                                        <i class="<?php echo e($value->icon); ?>" aria-hidden="true"></i>
                                    </a>
                                </li>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </ul>
            ...
            <div class="nf-bottom">
                <div class="nf-bottom-inner">
                    <span>Copyright © <?php echo e(date('Y')); ?> <?php echo e($generalsetting->name); ?>. All rights reserved</span>
                    <span class="nf-divider">|</span>
                    <span>Website Designed by:</span>
                    <a href="https://www.creativedesign.com.bd" target="_blank" rel="noopener">
                        <img src="<?php echo e(asset('public/uploads/creativedesign.png')); ?>" alt="Creative Design">
    ...
    <div class="floating-contact-widget" id="floatingContactWidget">
        <div class="floating-contact-options" id="floatingContactOptions" aria-hidden="true">
            <?php if($fcMessengerUser !== ''): ?>
                <a href="https://m.me/<?php echo e(rawurlencode($fcMessengerUser)); ?>" target="_blank" rel="noopener" class="floating-contact-btn floating-contact-messenger" title="Messenger">
                    <i class="fab fa-facebook-messenger" aria-hidden="true"></i>
                </a>
            <?php endif; ?>
            <?php if($fcWaDigits !== ''): ?>
                <a href="https://wa.me/<?php echo e($fcWaDigits); ?>" target="_blank" rel="noopener" class="floating-contact-btn floating-contact-whatsapp" title="WhatsApp">
                    <i class="fab fa-whatsapp" aria-hidden="true"></i>
                </a>
            <?php endif; ?>
            <?php if($fcTel !== ''): ?>
                <a href="tel:<?php echo e(preg_replace('/\s+/', '', $fcTel)); ?>" class="floating-contact-btn floating-contact-phone" title="কল করুন">
    ...
    <nav class="mobile-bottom-nav">
        <a href="<?php echo e(route('home')); ?>" class="bottom-nav-item active">
        ...
        <?php if(Auth::guard('customer')->check()): ?>
            <a href="<?php echo e(route('customer.account')); ?>" class="bottom-nav-item">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>
                <span><?php echo e(Str::limit(Auth::guard('customer')->user()->name, 12)); ?></span>
            </a>
        <?php else: ?>
            <a href="<?php echo e(route('customer.login')); ?>" class="bottom-nav-item">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>
                <span>Login</span>
            </a>
        <?php endif; ?>
    ...
    <script>
        (function () {
            if (typeof toastr !== 'undefined') {
                var _to = <?php echo json_encode(config('toastr.options', []), 512) ?>;
    ...
    <script>
        ...
        (function() {
            function syncCartBadges() {
                $.get("<?php echo e(route('mobile.cart.count')); ?>", function(c) {
                    var count = c || "0";
            ...
            window.headerCartHoverRefresh = function() {
                ...
                $.get("<?php echo e(route('cart.header-hover')); ?>", function(html) {
                    $cont.html(html || '');
                });
            };
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            var whatsappNumber = "<?php echo e(preg_replace('/\D+/', '', (string)(optional($contact ?? null)->whatsapp ?? optional($contact ?? null)->hotline ?? optional($contact ?? null)->phone ?? '8801700000000'))); ?>";
    ...
    <?php echo $__env->make('frontEnd.layouts.partials.marketing_popup', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

    <?php echo $__env->yieldPushContent('script'); ?>
</body>
</html>
<?php /**PATH C:\dms office\pos ecommerce\resources\views/frontEnd/layouts/master.blade.php ENDPATH**/ ?>