                    ...
                    <div class="settings-area">
                        <div class="row g-4">
                            ...
                            <div class="col-lg-5 ps-lg-4 border-start-lg">
                                ...
                                <div class="mb-4">
                                    <label class="category-label">Badge / Title <small class="text-muted">(Optional - for Hot Deals)</small></label>
                                    <input type="text" class="form-control input-clean" name="title" value="{{ $edit_data->title ?? '' }}" placeholder="e.g. STARTING FROM TK 99 ONLY">
                                </div>
