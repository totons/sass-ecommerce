...
@push('css')
    ...
    <style>
        ...
        @media (max-width: 991.98px) {
            ...
            .filter_sort { justify-content: flex-end; margin-top: 8px; }
        ...
        @media (max-width: 767.98px) {
            ...
            .cust_according_body ul li a,
            .subcategory-filter-name { font-size: 13px; }
        }
    </style>
@endpush
@push('seo')
                ...
                <div class="col-sm-9">
                    <section class="category-products-section">
                        <div class="category-products-head">
                            <h2 class="category-products-title">{{ $category->name }}</h2>
                        </div>
...
@push('script')
    ...
    <script>
        // Category filters: submit the main filter form consistently.
